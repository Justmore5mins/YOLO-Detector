...
class Detect:
    ...
    def stream(self, camera: int = 0, resolution: tuple[int, int] = (480, 640), cls: list[int] = None,gui:bool=True) -> None:
        ...
        functions: isCentered, isNotCentered, others
        each of function are optional
        '''
        ...
        while True:
            ...
            for res in results:
                ...
                for i, box in enumerate(boxes):
                    ...
                    cv2.putText(img, f"{self.model.names[int(box.cls)]}", (x1-30, y1-30), font, fontscale, color, thickness)
